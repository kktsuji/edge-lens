  ...
  return (
    <span className="inline-flex" title={label}>
      <button
        ...
        className={
          disabled
            ? "inline-flex items-center justify-center rounded bg-gray-700 px-2 py-1 text-sm text-gray-600 cursor-not-allowed sm:px-3 sm:py-1.5"
            : "inline-flex items-center justify-center rounded bg-gray-600 px-2 py-1 text-sm text-white hover:bg-gray-500 sm:px-3 sm:py-1.5"
        }
        aria-label={label}
      >
